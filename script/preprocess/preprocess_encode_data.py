...
from MethylAI.src.preprocess.preprocess import EncodeMethylationFile

def main_argparse() -> None:
    parser = argparse.ArgumentParser(description="Preprocess ENCODE DNA methylation files.")

    parser.add_argument("--input_folder", required=True, help="Folder containing ENCODE methylation files.")
    parser.add_argument("--input_file_suffix", required=True, help="Suffix of ENCODE methylation files.")
