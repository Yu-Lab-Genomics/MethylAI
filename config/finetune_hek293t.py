...
resnet_parameter_dict = {
    ...
    # 训练集文件设置
    'train_set_file': f'{dataset_folder}/human_293t_smooth_raw_window3_train_chromosome.pkl',
    'bed_dataset_to_repetition_dict': {},
    'validation_set_file': f'{dataset_folder}/human_293t_smooth_raw_window3_validation_chromosome.pkl',
