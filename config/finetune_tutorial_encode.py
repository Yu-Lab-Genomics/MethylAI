methylai_config_dict = {
    ...
    'max_step_per_epoch': 999_000_000,
    'learning_rate': 0.0001,
    'output_block_learning_rate': 0.0006,
    'weight_decay': 0.01,
    'batch_size': 50,
    'output_folder': (
      'result/finetune_tutorial_encode'
    ),
    'output_result_file': 'finetune_tutorial_encode_result.txt',
    'pretrain_checkpoint_path': 'checkpoint/MethylAI_pretrain_12_species.pth',
    ...
    'train_set_file': (
      'data/encode_dataset_1/encode_train_set.pkl'
    ),
    'cpg_index_to_repetition_dict': {},
    'validation_set_file': (
      'data/encode_dataset_1/encode_validation_set.pkl'
    ),
